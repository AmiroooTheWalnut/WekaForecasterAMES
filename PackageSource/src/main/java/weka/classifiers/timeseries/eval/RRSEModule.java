...
public class RRSEModule extends ErrorModule {
  ...
  protected void evaluatePredictionForTargetForInstance(int targetIndex, 
      Prediction forecast, double actualValue) {
    
    double predictedValue = forecast.predicted();
    double[][] intervals=null;
    if(forecast instanceof NumericPrediction)
    {
        intervals = ((NumericPrediction)forecast).predictionIntervals();
    }
   ...
   * reason. 
   */
  public void evaluateForInstance(List<Prediction> forecasts, 

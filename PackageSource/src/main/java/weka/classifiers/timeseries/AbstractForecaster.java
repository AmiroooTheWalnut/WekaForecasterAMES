...
public abstract class AbstractForecaster implements TSForecaster, 
  ...
  public void setFieldsToForecast(List<String> targets) throws Exception {
        
    m_fieldsToForecast = targets;
  }
   ...
   */
  public abstract List<List<Prediction>> forecast(int numSteps, 
      PrintStream... progress) throws Exception;
